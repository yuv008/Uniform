    ...
    <section className="py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="font-serif text-4xl md:text-5xl font-bold text-foreground mb-6">Our Product Range</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          {products.map((product, index) => (
            <div
              key={index}
              className="group rounded-2xl overflow-hidden bg-secondary border border-border shadow-sm hover:shadow-xl transition-shadow flex flex-col"
            >
        ...
        <div className="text-center mt-16">
          <Link href="/products">
            <Button size="lg" className="bg-primary hover:bg-primary/90 font-sans uppercase tracking-widest px-10 py-4 rounded-full">
              View All Products
            </Button>
          </Link>
        </div>
